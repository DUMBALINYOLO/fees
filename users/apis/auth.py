    ...
    def post(self, request, *args, **kwargs):
        ...
        if user == 'An account with this email address does not Exist':
            ...
            try:
                ...
                message =  f'May you click  https://www.ubuntuafropublishers.co.zw/#/reset and copy this code: {icode} to reset your password'
                send_mail(
                    'Reset Password For Ubuntu-Afro Publishers',
                    message,
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            zemail = send_mail(
                ...
                'May you click  https://www.ubuntuafropublishers.co.zw/#/activate in order to activate your account.',
                settings.EMAIL_HOST_USER ,
                [request.data['email']],
                fail_silently=False,
            )
