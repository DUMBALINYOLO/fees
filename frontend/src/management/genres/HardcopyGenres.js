...
import { getHardcopyGenres, addHardcopyGenre, editHardcopyGenre} from '../../actions/publications/publications';
...
const Genres = (props) => {
    ...
    const saveProduct = (e) => {
        ...
        if (record.name.trim()) {
            let _record = {...record};
            if (record.id) {
                props.editHardcopyGenre(record.id, record, token);
                ...
                props.addHardcopyGenre(_record, token)
                setNewRecord(_record)
                props.getHardcopyGenres(token);
    ...
    const handleClick = id =>{
      history.push(`/managementdashboard/hardcopy-genres/${id}`)
    }
...
const mapStateToProps = state =>({
    records: state.publications.hardcopygenres,
...
export default connect(
  mapStateToProps,
  {getHardcopyGenres, addHardcopyGenre, editHardcopyGenre} )
  (Genres);
