...
const Consumables = (props) => {
    ...
    const saveProduct = (e) => {
        ...
        if (record.name.trim()) {
            ...
            if (record.id) {
                ...
                props.editConsumable(record.id, record, token);
                ...
                props.addConsumable(_record, token)
                setNewRecord(_record)
                props.getConsumables(token);
    ...
    const handleClick = id =>{
      history.push(`/managementdashboard/inventory/consumables/${id}`)
    }
            ...
            <div className="datatable-crud-demo">
                ...
                >
                  ...
                  <div className="p-fluid p-formgrid p-grid">
                      ...
                      <Divider type="dashed"/>
                      <div className="p-field p-col-12 p-md-12">
                        <label htmlFor="righticon">SKU</label>
                        <span className="p-float-label p-input-icon-right">
                            ...
                            <InputText
                                ...
                                tooltip="Choose SKU"
                            />
                            {submitted && !record.sku && <small className="p-error">Name is required.</small>}
...
const mapStateToProps = state =>({
    records: state.inventory.consumables,
