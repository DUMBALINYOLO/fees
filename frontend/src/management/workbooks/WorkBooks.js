...
const WorkBooks = (props) => {
    ...
    const saveProduct = (e) => {
        ...
        if (record.name.trim()) {
            ...
            if (record.id) {
                ...
                props.editWorkbook(record.id, record, token);
                ...
                props.addWorkbook(_record, token)
                setNewRecord(_record)
                props.getWorkbooks(token);
    ...
    const removeWorkBook = (id, data, token) => {
        props.deleteWorkbook(id, data, token);
        props.getWorkbooks(token);
        ...
        return (
            <React.Fragment>
                ...
                <Button
                  ...
                  onClick={() => removeWorkBook(rowData.id, rowData, token)}
...
export default connect(
  mapStateToProps,
  {getWorkbooks, deleteWorkbook, editWorkbook,addWorkbook} )
  (WorkBooks);
