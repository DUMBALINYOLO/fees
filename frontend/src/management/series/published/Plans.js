                ...
                <div className="card">
                    ...
                    <DataTable
                      ...
                      >
                        ...
                        />
                        <Column
                          field="online_read_price"
                          header="ONLINE READ PRICE"
                          sortable
                          filter
                      ...
                      <div className="p-field p-col-12 p-md-12">
                        ...
                        <div className="p-field p-col-12 p-md-12">
                          <span className="p-float-label p-input-icon-right">
                              ...
                              <InputNumber
                                id="rate"
                                value={record.online_read_price}
                                onChange={(e) => onInputNumberChange(e, 'online_read_price')}
                                autoFocus
                                ...
                                step={0.05}
                              />
                              {submitted && !record.online_read_price && <small className="p-error">Name is required.</small>}
                            </span>
                        </div>
                  </div>
