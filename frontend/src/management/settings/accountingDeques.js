...
class AccountingDeques extends React.Component {
  constructor(props){
    super(props);
    this.state = {
              ...
              <Toolbar>
                <div className={classes.flex}>
                  <div className={classes.wrapper}>
                    ...
                    <input className={classes.input} placeholder="FIND ACCOUNTS" onChange={(event) => this.handleSearch(event)} />
                  </div>
                </div>
              </Toolbar>
            </AppBar>
              ...
              <Grid container spacing={2}>
                  ...
                  <Grid item sm={4} xs={12}>
                    <Button
                      ...
                      className={classes.button}
                      component={Link}
                      to={link.minterestbearingaccounts}
                    >
                      <span className={classes.text}>
...
export default withStyles(styles)(AccountingDeques);
