...
const LockedSeries = (props) => {
    ...
    useEffect(() => {
      if(!props.fetched) {
          props.getUnverifiedOrders(token);
      }
    ...
    const changeOrder = (id, data, token) => {
      props.verifyOrder(id, data, token);
      props.getUnverifiedOrders(token);     
    }
        ...
        return (
            <React.Fragment>
                <Button
                  ...
                  label='VERIFY'
                  onClick={() => changeOrder(rowData.id, rowData, token)}
                />
                <Button
            ...
            <div className="datatable-crud-demo">
                ...
                >
                  <CreateOrder
                    ...
                    getOrders={props.getUnverifiedOrders}
                  />
                </Dialog>
...
const mapStateToProps = state =>({
    records: state.orders.unverifiedorders,
...
export default connect(
  mapStateToProps,
  {getUnverifiedOrders,verifyOrder },
  )
  (LockedSeries);
