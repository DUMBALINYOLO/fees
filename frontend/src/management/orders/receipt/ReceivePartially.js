...
import {receivePartiallyStock} from '../../../actions/inventory/orders'
...
class CreateBill extends React.Component {
  ...
  onSubmit = (e) => {
    ...
    this.props.receivePartiallyStock(this.props.data.id, stock, this.props.token);
