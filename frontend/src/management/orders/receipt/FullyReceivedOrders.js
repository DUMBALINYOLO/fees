...
const LockedSeries = (props) => {
    ...
    useEffect(() => {
      if(!props.fetched) {
          props.getFullyReceivedPaidOrders(token);
      }
    ...
    const handleClick = id =>{
      history.push(`/managementdashboard/inventory/fullyreceived-orders/${id}`)
    }
...
const mapStateToProps = state =>({
    records: state.orders.fullyreceivedorders,
