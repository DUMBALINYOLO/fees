...
class ScrollIconTabs extends React.Component {
  ...
  componentDidMount() {
    if (this.props.token !== undefined && this.props.token !== null) {
      this.props.getActiveSupplier(this.props.match.params.id, this.props.token);
  ...
  componentWillReceiveProps(newProps) {
    if (newProps.token !== this.props.token) {
      if (newProps.token !== undefined && newProps.token !== null) {
        this.props.getActiveSupplier(this.props.match.params.id, newProps.token);
    ...
    return (
      <ManagementLayout>
        <div className={classes.root}>
          ...
          {value === 0 && <TabContainer><SupplierDetail data={this.props.activesupplier}/></TabContainer>}
          {value === 1 && <TabContainer><Addresses data={this.props.activesupplier} editAddress={this.props.editSupplierAddress} addAddress={this.props.addSupplierAddress} getAddresses={this.props.getSupplierAddresses} addresses={this.props.supplieraddresses} token={this.props.token}/></TabContainer>}
