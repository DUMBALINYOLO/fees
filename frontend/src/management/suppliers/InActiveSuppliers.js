...
const Suppliers = (props) => {
    ...
    useEffect(() => {
      if(!props.fetched) {
          props.getDeactivedSuppliers(token);
      }
    ...
    const handleClick = id =>{
      history.push(`/managementdashboard/inventory/inactivesuppliers/${id}`)
    }
...
const mapStateToProps = state =>({
    records: state.suppliers.deactivatedsuppliers,
