...
import {getPublishedHardCopy} from '../../../actions/publications/publishedhardcopies';
...
class ScrollIconTabs extends React.Component {
  ...
  componentDidMount() {
    if (this.props.token !== undefined && this.props.token !== null) {
      this.props.getPublishedHardCopy(this.props.match.params.id, this.props.token);
  ...
  componentWillReceiveProps(newProps) {
    if (newProps.token !== this.props.token) {
      if (newProps.token !== undefined && newProps.token !== null) {
        this.props.getPublishedHardCopy(this.props.match.params.id, newProps.token);
...
const mapStateToProps = state => ({
    hardcopy: state.publishedhardcopies.publishedhardcopy,
