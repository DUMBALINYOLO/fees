...
function Invoice(props) {
  ...
  useEffect(() => {
    if(!props.fetched) {
        props.getPendingCustomerOrder(props.match.params.id, token);
...
const mapStateToProps = state =>({
  invoice: state.invoices.pendingcustomerorder,
...
mapStateToProps,
{getPendingCustomerOrder, getInvoiceLines } )
(Invoice);
