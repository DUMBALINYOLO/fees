...
function Invoice(props) {
  ...
  useEffect(() => {
    if(!props.fetched) {
        props.getPartiallyPaidInvoice(props.match.params.id, token);
      ...
      <Card className="card-box card-box-hover-rise">
        <div className="card-body p-4">
          ...
          <div className="d-flex flex-column flex-lg-row justify-content-between mb-4">
            <div>
              <div className="text-uppercase t mb-2 font-size-xs">
                Billed from
              </div>
...
const mapStateToProps = state =>({
  invoice: state.invoices.partiallypaidinvoice,
...
mapStateToProps,
{getPartiallyPaidInvoice, getInvoiceLines } )
(Invoice);
