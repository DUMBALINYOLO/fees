...
import {getCustomerUnpaidInvoices} from '../../actions/invoicing/customers';
...
function Payments(props) {
  ...
  useEffect(() => {
    if(!props.fetched) {
        props.getCustomerUnpaidInvoices(token);
    }
...
const mapStateToProps = state => ({
    invoices: state.customerinvoices.customerunpaidinvoices,
