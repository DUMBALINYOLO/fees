...
import {getCustomerFullyPaidInvoices} from '../../actions/invoicing/customers';
...
function Payments(props) {
  ...
  useEffect(() => {
    if(!props.fetched) {
        props.getCustomerFullyPaidInvoices(token);
    }
...
const mapStateToProps = state => ({
    invoices: state.customerinvoices.customerfullypaidinvoices,
