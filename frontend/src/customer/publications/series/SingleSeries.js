...
const Series = (props) => {
  ...
  const [seriesSubscribeDialog, setSeriesSubscribeDialog] = useState(false);
  ...
  const openSubscribe = () => {
    setSeriesSubscribeDialog(true);
  }

  const hideSubscribe = () => {
      setSeriesSubscribeDialog(false);
  }
          ...
          <Grid item xs={12} md={4}>
            <Grid container spacing={4}>
              <Grid item xs={12} lg={12}>
                <Card className="mb-4 bg-royal card-box-hover-rise">
                  ...
                  <CardContent className="p-3">
                    <Dialog
                      ...
                      <Dialog
                          visible={seriesSubscribeDialog}
                          style={{ width: '400px' }}
                          header="IMAGE FORM"
                          modal
                          className="p-fluid"
                          onHide={hideSubscribe}
                          >
                              <Subscribe
                                  id={series.id}
                                  seriesDialog={setSeriesSubscribeDialog}
                              />
                      </Dialog>
              ...
              <div className="py-2 bg-royal card-box-hover-rise">
                <Grid container spacing={4}>
                  {
                    languages.map((language) => {
                      return (
                        ...
                        <Grid item xs={12} sm={6} md={12} key={language.id}>
                          <Card className="card-box mb-4 p-3 bg-royal card-box-hover-rise">
                            <div>
