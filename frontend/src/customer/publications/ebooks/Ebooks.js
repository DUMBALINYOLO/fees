...
import {getCustomerEbooks} from '../../../actions/publications/publications';
import AOS from "aos";
...
const Ebooks = props => {
  ...
  const handleClick = id =>{
    history.push(`/customers/ebooks/${id}`)
  }
...
const mapStateToProps = state =>({
    records: state.publications.customerebooks,
})
