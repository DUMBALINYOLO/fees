...
export default function LivePreviewExample() {
  ...
  return (
    <Corporate>
      <div className="py-5 bg-night-sky" data-aos="zoom-in-up">
        <div className="text-center my-5">
          <h1 className="display-4 text-white mb-3 font-weight-bold">
            FLEXIBLE MEASUREMENT & CONTROL SYSTEMS NEWSLETTER
          </h1>
          <p className="font-size-lg text-white-50">
            FOLLOW OUR MONTHLY NEWSLETTER ON TECHNOLOGY AND INDUSTRIALIZATION
          </p>
        </div>
        <Container>
