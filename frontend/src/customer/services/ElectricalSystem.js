...
import {getElectricalSystem, getImages, getProjects} from '../../actions/services';
import {
  Grid,
  InputAdornment,
  Avatar,
...
const Service = (props) => {
  ...
  useEffect(() => {
    if(!props.fetched) {
      props.getElectricalSystem(props.match.params.id);
...
const mapStateToProps = state =>({
  service: state.services.electricalsystem,
...
mapStateToProps,
{getElectricalSystem, getImages, getProjects} )
(Service);
