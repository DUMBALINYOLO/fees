    ...
    return (
      <Corporate>
        <div className={classes.root}>
          <AppBar position="static" color="primary" opacity={0.1}>
            <Tabs
              value={value}
              ...
              variant="fullWidth"
            >
              <Tab label="COMMUNICATION & INDUSTRIAL NETWORKING SYSTEMS" />
              <Tab label=" CONTROL & DATA ACQUISITION SYSTEMS" />
              <Tab label="ELECTRICAL SWITCHGEAR & CABINETS" />
              <Tab label="CYBER SECURITY  SYSTEMS" />
              <Tab label="INSTRUMENTATION SYSTEMS" />
              <Tab label="SOFTWARE SYSTEMS" />
              <Tab label="WEIGHING SYSTEMS" />
              <Tab label="MOTORS & DRIVES" />
            </Tabs>
          </AppBar>
