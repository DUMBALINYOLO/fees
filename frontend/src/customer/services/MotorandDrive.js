...
import {getMotorsAndDrive, getImages, getProjects} from '../../actions/services';
import {
  Grid,
  InputAdornment,
  Avatar,
...
const Service = (props) => {
  ...
  useEffect(() => {
    if(!props.fetched) {
      props.getMotorsAndDrive(props.match.params.id);
...
const mapStateToProps = state =>({
  service: state.services.motoranddrive,
...
mapStateToProps,
{getMotorsAndDrive, getImages, getProjects} )
(Service);
