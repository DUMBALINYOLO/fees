...
import {getControlSystem, getImages, getProjects} from '../../actions/services';
import {
  Grid,
  InputAdornment,
  Avatar,
...
const Service = (props) => {
  ...
  useEffect(() => {
    if(!props.fetched) {
      props.getControlSystem(props.match.params.id);
...
const mapStateToProps = state =>({
  service: state.services.controlsystem,
...
mapStateToProps,
{getControlSystem, getImages, getProjects} )
(Service);
