...
import {getCommunicationSystems} from '../../actions/services';
...
function Software(props) {
  ...
  const handleClick = id =>{
    history.push(`/communicationsystems/${id}`)
  }
...
const mapStateToProps = state =>({
  records: state.services.communicationsystems,
})
