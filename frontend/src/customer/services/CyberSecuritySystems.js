...
import {getCyberSecuritySystems} from '../../actions/services';
...
function Software(props) {
  ...
  const handleClick = id =>{
    history.push(`/cybersecuritysystems/${id}`)
  }
...
const mapStateToProps = state =>({
  records: state.services.cybersecuritysystems,
})

const MappedServices = connect(
mapStateToProps,
{getCyberSecuritySystems} )
(Software);
