...
import {getWeighingSystem, getImages, getProjects} from '../../actions/services';
import {
  Grid,
  InputAdornment,
  Avatar,
...
const Service = (props) => {
  ...
  useEffect(() => {
    if(!props.fetched) {
      props.getWeighingSystem(props.match.params.id);
...
const mapStateToProps = state =>({
  service: state.services.weighingsystem,
...
mapStateToProps,
{getWeighingSystem, getImages, getProjects} )
(Service);
