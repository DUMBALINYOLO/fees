...
import {getCommunicationSystem, getImages, getProjects} from '../../actions/services';
import {
  Grid,
  InputAdornment,
  Avatar,
...
const Service = (props) => {
  ...
  useEffect(() => {
    if(!props.fetched) {
      props.getCommunicationSystem(props.match.params.id);
...
const mapStateToProps = state =>({
  service: state.services.communicationsystem,
...
mapStateToProps,
{getCommunicationSystem, getImages, getProjects} )
(Service);
