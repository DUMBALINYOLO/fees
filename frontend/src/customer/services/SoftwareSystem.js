...
import {getSoftware, getImages, getProjects} from '../../actions/services';
import {
  Grid,
  InputAdornment,
  Avatar,
...
const Service = (props) => {
  ...
  useEffect(() => {
    if(!props.fetched) {
      props.getSoftware(props.match.params.id);
...
const mapStateToProps = state =>({
  service: state.services.softwaresystem,
...
mapStateToProps,
{getSoftware, getImages, getProjects} )
(Service);
