...
import {getCyberSecuritySystem, getImages, getProjects} from '../../actions/services';
import {
  Grid,
  InputAdornment,
  Avatar,
...
const Service = (props) => {
  ...
  useEffect(() => {
    if(!props.fetched) {
      props.getCyberSecuritySystem(props.match.params.id);
...
const mapStateToProps = state =>({
  service: state.services.cybersecuritysystem,
...
mapStateToProps,
{getCyberSecuritySystem, getImages, getProjects} )
(Service);
